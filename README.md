...
| [`bilibili-apple.user.css`](bilibili-apple.user.css) | 8.18.0 | `bilibili.com` 主站 / 动态 / 搜索 / 空间 / 消息 | 首页网格、播放页推荐与播放器圆角、动态视频、动态页 Apple 背景、个人空间卡片、持续吸顶且随分类导航展开的无接缝顶栏玻璃及全站紫色强调色 |
