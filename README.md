...
| [`bilibili-apple.user.css`](bilibili-apple.user.css) | 8.14.1 | `bilibili.com` 主站 / 动态 / 搜索 / 空间 / 消息 | 首页网格、播放页推荐与播放器圆角、动态视频、动态页 Apple 背景、个人空间卡片、无接缝 YouTube 风格顶栏玻璃及全站紫色强调色 |
...
| [`instagram-apple.user.css`](instagram-apple.user.css) | 1.0.4 | `instagram.com` | 左侧导航、快拍 Dock 单点放大、信息流与评论卡片、Messages 浮钮；材质与位移分层渲染 |
