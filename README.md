...
| [`google-apple.user.css`](google-apple.user.css) | 1.5.22 | `google.com` 及 8 个地区域名 | 搜索结果与顶部控件的动效和磨砂玻璃 |
| [`xiaohongshu-apple.user.css`](xiaohongshu-apple.user.css) | 1.4.0 | `xiaohongshu.com` | 左侧导航按钮和图文卡片的悬浮动效，吸顶搜索框与侧栏磨砂玻璃 |
