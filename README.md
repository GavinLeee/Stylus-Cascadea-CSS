...
| [`youtube-apple.user.css`](youtube-apple.user.css) | 2.20.48 | `youtube.com` | 顶栏、分类栏、左侧导航和视频卡片的悬浮动效 |
| [`x-apple.user.css`](x-apple.user.css) | 1.7.15 | `x.com`、`twitter.com` | 右栏模块、推文信息流和左侧导航的卡片与悬浮动画，串联推文之间不画分隔线 |
| [`google-apple.user.css`](google-apple.user.css) | 1.5.21 | `google.com` 及 8 个地区域名 | 搜索结果与顶部控件的动效和磨砂玻璃 |
