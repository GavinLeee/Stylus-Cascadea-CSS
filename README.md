...
| [`apple-podcasts-source-switcher.user.js`](apple-podcasts-source-switcher.user.js) | 1.2.4 | `podcasts.apple.com` | 保留 Apple 原生播放与切集体验，仅在原生界面完成切换后将《哈喽怪谈》的音频替换为喜马拉雅播放源；同步暂停、切集、标题与卡片动画状态 |
